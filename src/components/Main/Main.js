...
const news = [
  ...
  },
  {
    ...
    text: 'ЦТИ по заказу МВПС разработал ИЭТР с подробной структурой покупных сборочных узлов, обслуживаемых при ТО и ДР, для подвижного состава Иолги 1.0',
    img: newsIvolga,    
    date: '15 Янв 2022',
  },
];
    ...
    <div className='main'>
      ...
      <div className='main__slider'>
        ...
        <h3 className='slider__subtitle'>
          <span className='slide__title_span'>Надежный партнер на пути</span>
