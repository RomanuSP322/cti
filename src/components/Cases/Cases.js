        ...
        <>
          ...
          <div className="case_wrapper">
            {cases.map((item, idx) => {
              return (
                <div
                  className={`case ${idx === cur ? "case_active" : ""}`}
                  key={idx}
                >
            ...
            <button
              className="case__button case__button_about"
              onClick={() => handleClick(cases[cur].path)}
            >
              Подробнее
            </button>
          ...
          <button
            className="case__button case__button_projects"
