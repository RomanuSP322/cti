...
import isokintroMp from "../../video/isok.mp4";
          ...
          <div className="isok__video-content">
            ...
            <div className="isok__video-wrapper">
              <div className="isok__videos" style={position}>
                <video autoPlay muted loop playsInline className="isok__video">
                  <source src={isokintro} type="video/webm" />
                  <source src={isokintroMp} type="video/mp4" />
                </video>
              ...
              {isokdata.map((item, idx) => {
                return (
                  <div className="capabilities__item" key={idx}>
                    ...
                    >
                      <h3
                        className={`capabilities__item-title isok__item-title ${
                          idx + 1 === cur
